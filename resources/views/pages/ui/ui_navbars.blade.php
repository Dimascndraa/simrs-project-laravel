...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		...
		@slot('sh_descipt') Documentation and examples for Bootstrap’s powerful, responsive navigation header, the
		navbar. Includes support for branding, navigation, and more, including support for our collapse plugin. @endslot
		@endcomponent
	</div>
	<div class="row">
		<div class="col-xl-6">
							...
							<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
								...
								<div class="collapse navbar-collapse" id="navbarColor01">
									...
									<button type="button" class="btn btn-info" data-toggle="popover"
										data-container="#navbarColor01" data-placement="top" title="" data-html="true"
										data-content='
							...
							<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
								...
								<div class="collapse navbar-collapse" id="navbarColor02">
									...
									<button type="button" class="btn btn-outline-light" data-toggle="popover"
										data-container="#navbarColor02" data-placement="top" title="" data-html="true"
										data-content='
					<form class="form-inline">
						<input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
					</form>'>
							...
							<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
								...
								<div class="collapse navbar-collapse" id="navbarColor03">
									...
									<button type="button" class="btn btn-outline-danger" data-toggle="popover"
										data-container="#navbarColor03" data-placement="top" title="" data-html="true"
										data-content='
					<form class="form-inline">
						<input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
					</form>'>
					...
					<div class="panel-content">
						<div class="panel-tag">
							<p>Use <a href="#">position utilities</a> to place navbars in non-static positions. Choose
								...
								<code>position: fixed</code>, meaning they’re pulled from the normal flow of the DOM and
								may require custom CSS (e.g., <code>padding-top</code> on the <code>&lt;body&gt;</code>)
