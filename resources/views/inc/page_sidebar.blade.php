                ...
                <ul>
                    <li
                        ...
                        <ul>
                            ...
                            <li class="{{ set_active('pasien_non_rm') }}">
                                <a href="/pasien_non_rm" title="Pasien Non Rekam Medis"
                                    data-filter-tags="pasien non rekam medis">
                                    <span class="nav-link-text" data-i18n="nav.pasien_non_rm">Pasien Non Rekam
                                        Medis</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ set_active('daftar_registrasi_pasien') }}">
                        <a href="/daftar_registrasi_pasien" title="Daftar Registrasi Pasien"
                            data-filter-tags="pendaftaran daftar pegistrasi pasien">
                            <span class="nav-link-text" data-i18n="nav.pendaftaran_daftar_registrasi_pasien">Daftar
